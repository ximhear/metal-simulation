...
![macOS에서 실행 중인 Galaxy Lab의 조석 꼬리 시나리오](docs/images/macos-encounter.jpg)
...
- **네 가지 시나리오** — 조석 꼬리, 정면 충돌, 스쳐 지나가기, 단독 은하 검증.
- **관측 조작** — 드래그 회전, 확대, 별 밝기, 위에서 보기, 암흑물질 분포 표시.
...
| 드래그 / 핀치 또는 확대 슬라이더 | 관측 방향과 배율 변경 |
...
- 질량 3의 지수 원반과 질량 17의 살아 있는 암흑물질 헤일로로 각 은하를 구성합니다.
